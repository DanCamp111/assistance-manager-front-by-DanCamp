class IncidenciaDTO {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (horaSalida != null && horaSalida!.isNotEmpty) data['hora_salida'] = horaSalida;
    if (horaRegreso != null && horaRegreso!.isNotEmpty) data['hora_regreso'] = horaRegreso;
    if (horaTransporte != null) data['hora_transporte'] = horaTransporte;
    if (documentoJustificativo != null) data['documento_justificativo'] = documentoJustificativo;
